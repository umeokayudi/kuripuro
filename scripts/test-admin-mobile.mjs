...
testAdminPhoneFrame()
assert(isAdminMobileTabPath('/') && isAdminMobileTabPath('/jobs') && isAdminMobileTabPath('/live') && isAdminMobileTabPath('/salary-periods'), 'main mobile tabs')
assert(!isAdminMobileTabPath('/ai') && !isAdminMobileTabPath('/reports') && !isAdminMobileTabPath('/account') && !isAdminMobileTabPath('/clients'), 'other routes use More')
